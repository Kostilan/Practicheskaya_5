...
if(!empty($_POST)){
    ...
    $query = "insert into users (id_user, surname, name, patronymic, birthday, phone, gender, pasword, role, awards, created_at, photo) values (null,'$surname','$name','$patronymic','$birthday','$phone','$gender','$pass','2','$awards','$created_at','$photo')";
